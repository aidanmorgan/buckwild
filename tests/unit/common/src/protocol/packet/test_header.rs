use buckwild_common::protocol:packet::header::*;
#[test]
    fn test_session_id() {
    ...
    fn test_packet_header_serialization() {
        ...
        assert_eq!(deserialized.payload_length(), 1024);
    }
    ...
    fn test_packet_header_atomic_operations() {
        ...
        header.set_sequence_number(0x12345678);
        assert_eq!(header.sequence_number(), 0x12345678);
        
        header.set_ack_number(0x87654321);
        assert_eq!(header.ack_number(), 0x87654321);
        
        header.set_payload_length(2048);
        assert_eq!(header.payload_length(), 2048);
